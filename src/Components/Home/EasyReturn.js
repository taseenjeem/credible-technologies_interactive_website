        ...
        <section className="hero mb-24">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    ...
                    <p className="py-6 text-justify">We are available in 86 countries in the world. They can issue warranty any where from our outlets. Because we provide international warranty. Customer can easy return our products home with one single tap. Our delivery guy will come to your door step to receive the product. For more information please check our privacy policies.</p>
