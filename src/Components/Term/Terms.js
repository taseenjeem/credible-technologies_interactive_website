    ...
    return (
        <section className='mx-auto max-w-screen-xl px-3 my-28'>
            ...
            <div className='bg-white p-7 rounded-lg shadow-lg'>
                <h1 className='lg:text-5xl text-3xl text-center lg:leading-relaxed font-semibold capitalize'>our terms conditions<br /> and privacy concerns</h1>
            </div>
            ...
            <div className='container w-11/12 mx-auto pt-20 max-w-[1196px] text-start pb-20'>
                <div>
                    ...
                    <p className='text-[16px] text-[#0B1B28] mt-5 leading-7'>Nowadays, the network plays an import role in people’s life. In the process of the improvement of the people’s living standard, people’s demands of the life’s quality and efficiency is more higher, the traditional Credible Technologies Ltd.’s inconvenience gradually emerge, and the online Credible Technologies Ltd. has gradually be used in public.</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>The online Credible Technologies Ltd. is a revolution of technology industry. The traditional Credible Technologies Ltd.s’ operation time, address and space is limited, so the types of technologies and technologies to find received a degree of restriction. But the online Credible Technologies Ltd. broke the management mode of traditional Credible Technologies Ltd., as long as you have a computer, you can buy the technology anywhere, saving time and effort, shortening the time of technology selection link effectively. The online Credible Technologies Ltd. system based on the principle of provides convenience and service to people.</p>
                </div>
                <div className='mt-5'>
                    <h2 className='text-2xl text-[#0B1B28] font-semibold uppercase'>Condition of Use</h2>
                    <h3 className='text-2xl text-[#0B1B28] font-medium uppercase mt-4'>A. Your Account</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>To access certain services offered by the platform, we may require that you create an account with us or provide personal information to complete the creation of an account. We may at any time in our sole and absolute discretion, invalidate the username and/or password without giving any reason or prior notice and shall not be liable or responsible for any losses suffered by, caused by, arising out of, in connection with or by reason of such request or invalidation.</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>

                        <ul className='list-disc pl-8'>
                            <li>You are responsible for maintaining the confidentiality of your user identification, password, account details and related private information.</li>
                            <li> You agree to accept this responsibility and ensure your account and its related details are maintained securely at all times and all necessary steps are taken to prevent misuse of your account.</li>
                            <li>You should inform us immediately if you have any reason to believe that your password has become known to anyone else, or if the password is being, or is likely to be, used in an unauthorized manner.</li>
                            <li>You agree and acknowledge that any use of the Site and related services offered and/or any access to private information, data or communications using your account and password shall be deemed to be either performed by you or authorized by you as the case may be.</li>
                            <li>You agree to be bound by any access of the Site and/or use of any services offered by the Site (whether such access or use are authorized by you or not).</li>
                            <li> You agree that we shall be entitled (but not obliged) to act upon, rely on or hold you solely responsible and liable in respect thereof as if the same were carried out or transmitted by you. You further agree and acknowledge that you shall be bound by and agree to fully indemnify us against any and all losses arising from the use of or access to the Site through your account.</li>
                        </ul>
                    </p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                ...
                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>B. PRIVACY</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                ...
                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>C. PLATFORM FOR COMMUNICATION</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                ...
                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>D. CONTINUED AVAILABILITY OF THE SITE</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                ...
                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>E. LICENSE TO ACCESS THE SITE</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                ...
                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>F. YOUR CONDUCT</h3>
                ...
                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>G. YOUR SUBMISSION</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                ...
                <div className='mt-5'>
                    <h2 className='text-2xl text-[#0B1B28] font-semibold'>CONDITIONS OF SALE (BETWEEN SELLERS AND CUSTOMERS)</h2>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                    ...
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>A. CONDITIONS RELATED TO SALE OF THE PRODUCT OR SERVICE</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>This section deals with conditions relating to the sale of products or services on the Site.</p>
                </div>

                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>B. THE CONTRACT</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>
                        Your order is a legal offer to the seller to buy the product or service displayed on our Site. When you place an order to purchase a product, any confirmations or status updates received prior to the dispatch of your order serves purely to validate the order details provided and in no way implies the confirmation of the order itself. The acceptance of your order is considered confirmed when the product is dispatched to you. If your order is dispatched in more than one package, you may receive separate dispatch confirmations. Upon time of placing the order, we indicate an approximate timeline that the processing of your order will take however we cannot guarantee this timeline to be rigorously precise in every instance as we are dependent on third party service providers to preserve this commitment.
                        <ul className='list-disc p-4'>
                            <li>We commit to you to make every reasonable effort to ensure that the indicative timeline is met. </li>
                            <li>All commercial/contractual terms are offered by and agreed to between you and the sellers alone.</li>
                            <li>The commercial/contractual terms include without limitation price, shipping costs, payment methods, payment terms, date, period and mode of delivery,</li>
                            <li>Warranties related to products and services and after sales services related to products and services.</li>

                        </ul>
                        Credible Technologies Ltd. does not have any control or does not determine or advise or in any way involve itself in the offering or acceptance of such commercial/contractual terms between the you and the Sellers. The seller retains the right to cancel any order at its sole discretion prior to dispatch. We will ensure that there is timely intimation to you of such cancellation via an email or sms. Any prepayments made in case of such cancellation(s), shall be refunded to you within the time frames stipulated here.
                    </p>
                </div>

                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>C. RETURNS</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>Please review our Returns Policy for details.</p>
                </div>

                <div className='mt-5'>
                    <h3 className='text-2xl text-[#0B1B28] font-medium mt-4'>D. PRICING, AVAILABILITY AND ORDER PROCESSING</h3>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>All prices are listed in Bangladeshi Taka (BDT) and are inclusive of GST and are listed on the Site by the seller that is selling the product or service. Items in your Shopping Cart will always reflect the most recent price displayed on the item’s product detail page. Please note that this price may differ from the price shown for the item when you first placed it in your cart. Placing an item in your cart does not reserve the price shown at that time. It is also possible that an item’s price may decrease between the time you place it in your basket and the time you purchase it.</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>We are determined to provide the most accurate pricing information on the Site to our users; however, errors may still occur, such as cases when the price of an item is not displayed correctly on the Site. As such, we reserve the right to refuse or cancel any order. In the event that an item is mispriced, we may, at our own discretion, either contact you for instructions or cancel your order and notify you of such cancellation. We shall have the right to refuse or cancel any such orders whether or not the order has been confirmed and your prepayment processed. If such a cancellation occurs on your prepaid order, our policies for refund will apply. Please note that Ashora Online Bazar posses 100% right on the refund amount. Usually refund amount is calculated based on the customer paid price after deducting any sort of discount and shipping fee.</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>We list availability information for products listed on the Site, including on each product information page. Beyond what we say on that page or otherwise on the Site, we cannot be more specific about availability. Please note that dispatch estimates are just that. They are not guaranteed dispatch times and should not be relied upon as such. As we process your order, you will be informed by e-mail or sms if any products you order turn out to be unavailable.</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>Please note that there are cases when an order cannot be processed for various reasons. The Site reserves the right to refuse or cancel any order for any reason at any given time. You may be asked to provide additional verifications or information, including but not limited to phone number and address, before we accept the order.</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'>In order to avoid any fraud with credit or debit cards, we reserve the right to obtain validation of your payment details before providing you with the product and to verify the personal information you shared with us. This verification can take the shape of an identity, place of residence, or banking information check. The absence of an answer following such an inquiry will automatically cause the cancellation of the order within a reasonable timeline. We reserve the right to proceed to direct cancellation of an order for which we suspect a risk of fraudulent use of banking instruments or other reasons without prior notice or any subsequent legal liability.</p>

                    <h2 className='text-2xl text-[#0B1B28] font-semibold uppercase mt-5'>Others</h2>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'><strong>Stock availability:</strong> The orders are subject to availability of stock.</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'><strong>Delivery Timeline:</strong> The delivery might take longer than usual timeframe/line to be followed by Online Credible Technologies Ltd..</p>
                    <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'><strong>Refund Timeline:</strong> If any order is canceled, the payment against such order shall be refunded within 10 to 15 working days, but it may take longer time in exceptional cases. Provided that received cash back amount, if any, will be adjusted with the refund amount.</p>
                </div>
            </div>
