...
const Footer = () => {
    return (
        <section>
            <footer className="footer p-10 bg-base-200 text-base-content lg:px-24 px-3 grid lg:grid-cols-3 grid-cols-2">
            ...
            <footer className="footer py-4 bg-base-200 border-t text-base-content lg:px-24 px-3">
